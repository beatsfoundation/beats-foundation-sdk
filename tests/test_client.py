...
class TestBeatsFoundation:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "beats_foundation/_legacy_response.py",
                        "beats_foundation/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "beats_foundation/_compat.py",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/api/songs/id").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/api/songs/id", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/api/songs/id").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/songs/id").mock(side_effect=retry_handler)

        response = client.songs.with_raw_response.retrieve("id")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.songs.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.songs.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncBeatsFoundation:
    ...
    async def test_retries_taken(
        ...
        response = await client.songs.with_raw_response.retrieve("id")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.songs.with_raw_response.retrieve(
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.songs.with_raw_response.retrieve("id", extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from beats_foundation._utils import asyncify
        from beats_foundation._base_client import get_platform 
